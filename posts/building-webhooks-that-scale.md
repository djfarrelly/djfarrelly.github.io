...
![A simple webhook as part of your API server](/images/posts/building-webhooks-that-scale/simple-webhook.png)
...
![A webhook extracted to it's own service](/images/posts/building-webhooks-that-scale/webhook-service.png)
...
![A webhook responding immediately](/images/posts/building-webhooks-that-scale/immediate-response.png)
...
![A webhook with a queue and a worker](/images/posts/building-webhooks-that-scale/webhook-with-queue.png)
...
I hope this has given you a blueprint on how you can scale your own webhooks as your user base grows.
